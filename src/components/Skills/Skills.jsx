    ...
    <>
      ...
      <div className='skills__text'>
        <p className='skills__paragraph'>
          ...
          вёрстке использую методологию БЭМ. В качестве препроцессора пользуюсь
          Sass (синтаксис SCSS). Есть опыт натяжки вёрстки и доработки тем для
          WordPress. Для сборки использую Webpack.
        </p>
        <p className='skills__paragraph'>
