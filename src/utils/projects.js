...
const projects = [
  ...
  },
  {
    ...
    description: "Сайт-портфолио по макету из Figma. С помощью JS реализована возможность менять тему со светлой на тёмную, переключать язык, фильтровать фото по времена года. Вёрстка адаптирована под мобильные разрешения.",
  ...
  },
  {
    ...
    description: "Собственный дизайн. Свёрстан адаптивно. Натяжка вёрстки на Wordpress с последующей доработка функционала темы",
